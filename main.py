...
Work in progress. Eventual goals for this file:
    - main.py will act as a proxy script to call oscillating_masses.py, inverted_single_pendulum.py, etc.
    - The config.py file will specify which simulation the user desires to run and include options (pre-trained models)
    - Currently, this main.py file is actually populated with oscillating_masses.py which will be moved to its own
